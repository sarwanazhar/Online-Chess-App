...
const RoomScreen: React.FC = () => {
  const { room: roomIdParam, timeControl } = useLocalSearchParams<{ room: string; timeControl: string }>();
      ...
      {!isWaiting && (
        <>
          <View style={styles.header}>
            <MaterialCommunityIcons name="arrow-left" color="#FFF" size={hp(4)} onPress={handleExit} />
            <Timer
