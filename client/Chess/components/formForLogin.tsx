  ...
  return (
    <View style={styles.container}>
        ...
        onSubmit={async (values, { setErrors }) => {
          ...
          try {
            const response = await fetch(
              "http://192.168.100.9:8000/users/login",
              {
                method: "POST",
                headers: {
            ...
            if (data.message === "Invalid credentials") {
              setErrors({
                emailOrUsername: "Invalid username or password or email",
              });
            } else {
      ...
      <View style={styles.container2}>
        ...
        >
          <Text style={styles.buttonText2} disabled={isLoading}>
            {isLoading ? "Loading..." : "Create A New Account"}
          </Text>
        </TouchableOpacity>
      </View>
    </View>
